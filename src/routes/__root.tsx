...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "RT4D (Command, Control, Convert, Dominate) is an all-in-one lead generation and CRM platform built for real estate wholesalers, cash buyers, flippers, agents, a" },
      { property: "og:description", content: "RT4D (Command, Control, Convert, Dominate) is an all-in-one lead generation and CRM platform built for real estate wholesalers, cash buyers, flippers, agents, a" },
      { name: "twitter:description", content: "RT4D (Command, Control, Convert, Dominate) is an all-in-one lead generation and CRM platform built for real estate wholesalers, cash buyers, flippers, agents, a" },
