...
export function ComparisonTable() {
  return (
    <div>
      <div className="overflow-x-auto -mx-6 px-6">
        <div className="min-w-[640px] rounded-2xl border border-white/10 overflow-hidden">
          <div className="grid grid-cols-[1.6fr_1fr_1fr_1fr] text-xs uppercase tracking-wider font-bold">
            <div className="p-4 text-zinc-400 r4d-marketing-dark">Capability</div>
            <div className="p-4 text-center text-zinc-400 r4d-marketing-dark">List resellers</div>
            <div className="p-4 text-center text-zinc-400 r4d-marketing-dark">Cold-call agencies</div>
            <div className="p-4 text-center text-primary-foreground r4d-bg-lime border-x-2 border-primary">the engine</div>
          </div>
          {ROWS.map((row, i) => (
            <div
              key={row}
              className={`grid grid-cols-[1.6fr_1fr_1fr_1fr] text-sm border-t border-white/5 ${
                i % 2 === 0 ? "r4d-marketing-dark" : "bg-[#070707]"
              }`}
            >
              ...
              <div className="p-4 flex items-center justify-center text-zinc-600"><X className="w-4 h-4" /></div>
              <div className="p-4 flex items-center justify-center r4d-lime border-x-2 border-primary bg-primary/5">
      ...
      {/* Cost strip */}
      <div className="mt-6 rounded-2xl border border-white/10 r4d-marketing-dark p-6 md:p-7 text-sm leading-relaxed">
